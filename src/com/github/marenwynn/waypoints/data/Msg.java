...
public enum Msg {
    ...
    RESPAWN_NO_POWER("&6%s: Insufficient power, re-routing..."),
    RESPAWN_NOT_FOUND("Registered reintegration point is no longer functional, re-routing..."),
    ...
    SET_PLAYER_SPAWN("&6%s: &fWaypoint flagged for death-induced reintegration."),
